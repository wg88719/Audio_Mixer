...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = audio_to_axi_interface
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = audio_to_axi_interface_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_to_audio_interface
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = axi_to_audio_interface_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_to_audio_interface
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = axi_to_audio_interface_1
END
