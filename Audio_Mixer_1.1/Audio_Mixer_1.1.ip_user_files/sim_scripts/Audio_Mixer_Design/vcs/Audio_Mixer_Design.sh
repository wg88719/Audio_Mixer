...
reset_run()
{
  files_to_remove=(ucli.key Audio_Mixer_Design_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc Audio_Mixer_Design_simv.daidir)
...
elaborate()
{
  opts="-load "/media/harsha/HydraDrive/EDA/Vivado/Vivado/2015.4/lib/lnx64.o/libxil_vcs.so:xilinx_register_systf" -full64 -debug_pp -t ps -licqueue -l elaborate.log"

  vcs $opts xil_defaultlib.Audio_Mixer_Design xil_defaultlib.glbl -o Audio_Mixer_Design_simv
}
...
simulate()
{
  ...
  ./Audio_Mixer_Design_simv $opts -do simulate.do
}
# Script usage
usage()
{
