...
#
# Filename    : Audio_Mixer_Design.sh
...
#
# Generated by Vivado on Sat May 14 18:45:27 EEST 2016
# IP Build 1412160 on Tue Nov 17 13:47:24 MST 2015 
#
# usage: Audio_Mixer_Design.sh [-help]
# usage: Audio_Mixer_Design.sh [-lib_map_path]
# usage: Audio_Mixer_Design.sh [-noclean_files]
# usage: Audio_Mixer_Design.sh [-reset_run]
#
...
# executing this script. Please type 'Audio_Mixer_Design.sh -help' for more information.
#
...
# Script info
echo -e "Audio_Mixer_Design.sh - Script generated by export_simulation (Vivado v2015.4 (64-bit)-id)\n"

# Script usage
usage()
{
  msg="Usage: Audio_Mixer_Design.sh [-help]\n\
Usage: Audio_Mixer_Design.sh [-lib_map_path]\n\
Usage: Audio_Mixer_Design.sh [-reset_run]\n\
Usage: Audio_Mixer_Design.sh [-noclean_files]\n\n\
...
if [[ ($# == 1 ) && ($1 != "-lib_map_path" && $1 != "-noclean_files" && $1 != "-reset_run" && $1 != "-help" && $1 != "-h") ]]; then
  echo -e "ERROR: Unknown option specified '$1' (type \"./Audio_Mixer_Design.sh -help\" for more information)\n"
  exit 1
fi
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./Audio_Mixer_Design.sh -help\" for more information)\n"
        exit 1
      fi
...
create_lib_mappings()
{
  libs=(xil_defaultlib lib_cdc_v1_0_2 proc_sys_reset_v5_0_8 generic_baseblocks_v2_1_0 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_7 fifo_generator_v13_0_1 axi_data_fifo_v2_1_6 axi_crossbar_v2_1_8 axi_protocol_converter_v2_1_7)
  file="cds.lib"
  dir="ies"
...
compile()
{
  ...
  ncvlog -work xil_defaultlib $opts_ver +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    ...
    "$ref_dir/../../../bd/Audio_Mixer_Design/ip/Audio_Mixer_Design_processing_system7_0_0/sim/Audio_Mixer_Design_processing_system7_0_0.v" \

  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../Audio_Mixer_1.1.srcs/sources_1/ipshared/user.org/zed_audio_v1_0/hdl/adau1761_configuraiton_data.vhd" \
    "$ref_dir/../../../../Audio_Mixer_1.1.srcs/sources_1/ipshared/user.org/zed_audio_v1_0/hdl/i3c2.vhd" \
    "$ref_dir/../../../../Audio_Mixer_1.1.srcs/sources_1/ipshared/user.org/zed_audio_v1_0/hdl/ADAU1761_interface.vhd" \
    "$ref_dir/../../../../Audio_Mixer_1.1.srcs/sources_1/ipshared/user.org/zed_audio_v1_0/hdl/i2c.vhd" \
    "$ref_dir/../../../../Audio_Mixer_1.1.srcs/sources_1/ipshared/user.org/zed_audio_v1_0/hdl/i2s_data_interface.vhd" \
    "$ref_dir/../../../../Audio_Mixer_1.1.srcs/sources_1/ipshared/user.org/zed_audio_v1_0/hdl/adau1761_izedboard.vhd" \
    "$ref_dir/../../../../Audio_Mixer_1.1.srcs/sources_1/ipshared/user.org/zed_audio_v1_0/hdl/clocking.vhd" \
    "$ref_dir/../../../../Audio_Mixer_1.1.srcs/sources_1/ipshared/user.org/zed_audio_v1_0/hdl/audio_top.vhd" \
    "$ref_dir/../../../bd/Audio_Mixer_Design/ip/Audio_Mixer_Design_zed_audio_0_0/sim/Audio_Mixer_Design_zed_audio_0_0.vhd" \
    "$ref_dir/../../../bd/Audio_Mixer_Design/ipshared/xilinx.com/xlconstant_v1_1/xlconstant.vhd" \
    "$ref_dir/../../../bd/Audio_Mixer_Design/ip/Audio_Mixer_Design_xlconstant_0_0/sim/Audio_Mixer_Design_xlconstant_0_0.vhd" \
    "$ref_dir/../../../../Audio_Mixer_1.1.srcs/sources_1/ipshared/user.org/audio_to_axi_interface_v1_0/src/Zed_audio_interface.vhd" \
    "$ref_dir/../../../../Audio_Mixer_1.1.srcs/sources_1/ipshared/user.org/audio_to_axi_interface_v1_0/hdl/audio_to_axi_interface_v1_0_S00_AXI.vhd" \
    "$ref_dir/../../../../Audio_Mixer_1.1.srcs/sources_1/ipshared/user.org/audio_to_axi_interface_v1_0/hdl/audio_to_axi_interface_v1_0.vhd" \
    "$ref_dir/../../../bd/Audio_Mixer_Design/ip/Audio_Mixer_Design_audio_to_axi_interface_0_0/sim/Audio_Mixer_Design_audio_to_axi_interface_0_0.vhd" \
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/Audio_Mixer_Design/ip/Audio_Mixer_Design_rst_processing_system7_0_100M_0/sim/Audio_Mixer_Design_rst_processing_system7_0_100M_0.vhd" \
    "$ref_dir/../../../bd/Audio_Mixer_Design/ipshared/xilinx.com/xlconcat_v2_1/xlconcat.vhd" \
    "$ref_dir/../../../bd/Audio_Mixer_Design/ip/Audio_Mixer_Design_xlconcat_0_0/sim/Audio_Mixer_Design_xlconcat_0_0.vhd" \
    "$ref_dir/../../../../Audio_Mixer_1.1.srcs/sources_1/ipshared/user.org/axi_to_audio_interface_v1_0/src/Zed_audio_interface.vhd" \
    "$ref_dir/../../../../Audio_Mixer_1.1.srcs/sources_1/ipshared/user.org/axi_to_audio_interface_v1_0/hdl/axi_to_audio_interface_v1_0_S00_AXI.vhd" \
    "$ref_dir/../../../../Audio_Mixer_1.1.srcs/sources_1/ipshared/user.org/axi_to_audio_interface_v1_0/hdl/axi_to_audio_interface_v1_0.vhd" \
    "$ref_dir/../../../bd/Audio_Mixer_Design/ip/Audio_Mixer_Design_axi_to_audio_interface_0_0/sim/Audio_Mixer_Design_axi_to_audio_interface_0_0.vhd" \
    "$ref_dir/../../../../Audio_Mixer_1.1.srcs/sources_1/ipshared/user.org/top_level_v1_0/src/top_level.vhd" \
    "$ref_dir/../../../bd/Audio_Mixer_Design/ip/Audio_Mixer_Design_top_level_0_0/sim/Audio_Mixer_Design_top_level_0_0.vhd" \
    "$ref_dir/../../../../Audio_Mixer_1.1.srcs/sources_1/ipshared/tsotnep/filter_iir_v1_0/src/Multiplier.vhd" \
    "$ref_dir/../../../../Audio_Mixer_1.1.srcs/sources_1/ipshared/tsotnep/filter_iir_v1_0/src/IIR_Biquad_II_v3.vhd" \
    "$ref_dir/../../../../Audio_Mixer_1.1.srcs/sources_1/ipshared/tsotnep/filter_iir_v1_0/src/Filter_Top_Level.vhd" \
    "$ref_dir/../../../../Audio_Mixer_1.1.srcs/sources_1/ipshared/tsotnep/filter_iir_v1_0/hdl/FILTER_IIR_v1_0_S00_AXI.vhd" \
    "$ref_dir/../../../../Audio_Mixer_1.1.srcs/sources_1/ipshared/tsotnep/filter_iir_v1_0/hdl/FILTER_IIR_v1_0.vhd" \
    "$ref_dir/../../../bd/Audio_Mixer_Design/ip/Audio_Mixer_Design_FILTER_IIR_0_0/sim/Audio_Mixer_Design_FILTER_IIR_0_0.vhd" \
    "$ref_dir/../../../bd/Audio_Mixer_Design/ip/Audio_Mixer_Design_FILTER_IIR_1_0/sim/Audio_Mixer_Design_FILTER_IIR_1_0.vhd" \
    "$ref_dir/../../../../Audio_Mixer_1.1.srcs/sources_1/ipshared/tsotnep/volume_pregain_v1_0/src/MultiplierFP.vhd" \
    "$ref_dir/../../../../Audio_Mixer_1.1.srcs/sources_1/ipshared/tsotnep/volume_pregain_v1_0/src/AmplifierFP.vhd" \
    "$ref_dir/../../../../Audio_Mixer_1.1.srcs/sources_1/ipshared/tsotnep/volume_pregain_v1_0/src/Volume_Pregain_Top_Module.vhd" \
    "$ref_dir/../../../../Audio_Mixer_1.1.srcs/sources_1/ipshared/tsotnep/volume_pregain_v1_0/hdl/Volume_Pregain_v1_0_S00_AXI.vhd" \
    "$ref_dir/../../../../Audio_Mixer_1.1.srcs/sources_1/ipshared/tsotnep/volume_pregain_v1_0/hdl/Volume_Pregain_v1_0.vhd" \
    "$ref_dir/../../../bd/Audio_Mixer_Design/ip/Audio_Mixer_Design_Volume_Pregain_0_0/sim/Audio_Mixer_Design_Volume_Pregain_0_0.vhd" \
    "$ref_dir/../../../bd/Audio_Mixer_Design/ip/Audio_Mixer_Design_Volume_Pregain_1_0/sim/Audio_Mixer_Design_Volume_Pregain_1_0.vhd" \
    "$ref_dir/../../../bd/Audio_Mixer_Design/ip/Audio_Mixer_Design_axi_to_audio_interface_1_0/sim/Audio_Mixer_Design_axi_to_audio_interface_1_0.vhd" \
  ...
  ncvlog -work xil_defaultlib $opts_ver +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/Audio_Mixer_Design/ip/Audio_Mixer_Design_xbar_0/sim/Audio_Mixer_Design_xbar_0.v" \
  ...
  ncvlog -work xil_defaultlib $opts_ver +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/Audio_Mixer_Design/ip/Audio_Mixer_Design_auto_pc_0/sim/Audio_Mixer_Design_auto_pc_0.v" \

  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/Audio_Mixer_Design/hdl/Audio_Mixer_Design.vhd" \
...
elaborate()
{
  opts="-loadvpi "/media/harsha/HydraDrive/EDA/Vivado/Vivado/2015.4/lib/lnx64.o/libxil_ncsim.so:xilinx_register_systf" -64bit -relax -access +rwc -messages -logfile elaborate.log -timescale 1ps/1ps"
  libs="-libname unisims_ver -libname unimacro_ver -libname secureip -libname xil_defaultlib -libname lib_cdc_v1_0_2 -libname proc_sys_reset_v5_0_8 -libname generic_baseblocks_v2_1_0 -libname axi_infrastructure_v1_1_0 -libname axi_register_slice_v2_1_7 -libname fifo_generator_v13_0_1 -libname axi_data_fifo_v2_1_6 -libname axi_crossbar_v2_1_8 -libname axi_protocol_converter_v2_1_7"
  ncelab $opts xil_defaultlib.Audio_Mixer_Design xil_defaultlib.glbl $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.Audio_Mixer_Design -input simulate.do
}
# Script usage
usage()
{
