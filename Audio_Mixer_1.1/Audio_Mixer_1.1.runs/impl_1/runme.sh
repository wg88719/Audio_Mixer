...
HD_PWD='/home/harsha/work/Zynq/workspace/Audio_Mixer_1.1/Audio_Mixer_1.1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Audio_Mixer_Design_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Audio_Mixer_Design_wrapper.tcl -notrace
